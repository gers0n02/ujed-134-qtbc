...
$sql = "SELECT * FROM investigadores WHERE activo = 0 ORDER BY id DESC";
...
<head>
    ...
    <title>Papelera - Investigadores</title>
...
<div class="list-container main-content">
    ...
    <div class="table-responsive">
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="restaurar.php?id=<?= $row['id'] ?>" class="btn btn-edit">Restaurar</a>
                </td>
    ...
    <a href="index.php" class="btn-trash">Regresar</a>
</div>
